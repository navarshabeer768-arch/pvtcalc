...
export function App() {
  ...
  // The unlock code is the only credential there is — a correct code
  // either reuses an existing session or arrives with a freshly minted one
  // (see useCalculator/unlockService), so there is nothing left to do here
  // but switch views.
